...
Esto también será aplicado a los 7 colores que se originan a partir de la descomposición de la luz blanca, un fenómeno que permiten reflejar la lógica fundamental de la <span style="font-family: 'merriweather', serif; background: #8d9b1b26; border-radius: 5px; padding: 0px 3px 0px 3px; opacity: 0.9; text-shadow: -1px 2px 1px #5c5c5c78;">ley del 7</span>, recurrente en multiples ámbitos fenoménicos, y que será utilizada para referenciar a las Siete Supraconsciencias <font color="#e36c09">Ontogénicas</font>.
